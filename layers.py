...
class Conv2dBlock(nn.Module):
    def __init__(self, input_dim ,output_dim, kernel_size, stride,
        ...
        if activation == 'relu':
            ...
            self.activation = nn.LeakyReLU(0.01, inplace=False)
...
class Conv2dTransposeBlock(nn.Module):
    def __init__(self, input_dim ,output_dim, kernel_size, stride,
                 padding=0, output_padding=0, norm='none', activation='relu'):
        ...
        if norm == 'sn':
            ...
            self.conv = nn.ConvTranspose2d(input_dim, output_dim, kernel_size, stride, padding=padding, output_padding=output_padding, bias=self.use_bias)
...
class LayerNorm(nn.Module):
    def __init__(self, n_out, eps=1e-5, affine=True):
        ...
        self.affine = affine
        if self.affine:
            self.weight = nn.Parameter(torch.Tensor(n_out,1,1).uniform_())
